...
const Menu_v2 = ({ menuOpen, setMenuOpen}) => {
    ...
    const menu_options = 
        ...
        [
                ...
                label:  () => {
                        ...
                        <div className='flex flex-row gap-2 justify-start items-center text-start' >
                            <div className='h-[25px] w-[25px] '>
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="currentHeight" height="currentHeight" viewBox="0 0 48 48">
            ...
            },
            {
                type: 'navigate',
                link: '/cart',
                label:  (count = 8) => { return ( <div className='flex flex-row gap-2 justify-start items-center text-start' >
                                <div className='h-[25px] flex justify-center items-center text-white bg-gray-700 rounded-full w-[25px] '>
                                    {count}
                                </div>
    ...
    const menu_options_2 = [ 
        {
            ...
            label:  () => { return (
                <div className='flex flex-row gap-2'>
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="25"  height="25"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-help"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 17l0 .01" /><path d="M12 13.5a1.5 1.5 0 0 1 1 -1.5a2.6 2.6 0 1 0 -3 -4" /></svg>
                    Help Center
                </div>
            )}
        },
    ...
    return (
        <div style={{ height: user && user.name ? '316px' : '110px' }} className=' flex flex-col w-[230px] bg-white z-[9999] backdrop-blur-[5px] text-zinc-900 absolute top-[8px] right-[80px] rounded-[12px] border-[1.5px] border-black'>
            {
