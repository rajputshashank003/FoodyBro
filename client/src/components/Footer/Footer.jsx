...
function Footer() {
    return (
        <footer className="bg-[#D32F2F] rounded-md shadow m-4 mt-0">
            ...
            <span className="text-sm text-white sm:text-center ">©{new Date().getFullYear()}<a href="https://foodybro.vercel.app/" className="hover:underline">FoodyBro</a> All Rights Reserved.
            </span>
