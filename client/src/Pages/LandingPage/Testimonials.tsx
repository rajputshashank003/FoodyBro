        ...
        >
          <div className="flex items-center justify-center overflow-x-hidden pb-4 gap-4 ">
            <div>
              <div className="shadow-xl w-[310px] rounded-2xl p-8">
                <div className="font-medium pb-4">
                  I absolutely love FoodyBro! The app has a huge variety of food items to choose from, and the UI is super easy to navigate                </div>
              ...
              <div className="shadow-xl w-[310px] rounded-2xl p-8 my-6">
                <div className="font-medium pb-4">
                  I just tried FoodyBro for the first time and was impressed with how smooth everything was.
                </div>
                <div className="flex items-center gap-3">
            ...
            <div>
              <div className="shadow-xl w-[310px] rounded-2xl p-8">
                <div className="font-medium pb-4">
                  As someone who orders food multiple times a week, FoodyBro has become my go-to app. 
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="shadow-xl w-[310px] rounded-2xl p-8 my-6">
                <div className="font-medium pb-4">
                  The FoodyBro app has one of the best user interfaces I’ve seen! It’s super clean, modern, and intuitive.                 </div>
                <div className="flex items-center gap-3">
